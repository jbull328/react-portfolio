  ...
  render() {
    return (
      <div className="Landing">
        ...
        <p>
          • 4+ years professional experience with JavaScript technology on both
          Front End and Back End web application design and development.
          <br />• Proficiency in developing web applications with React UI,
          JQuery, Node, Express, AWS, API integrations, NoSQL Databases.
          <br />• In-depth experience in front-end web design and development
          using HTML5, CSS, Bootstrap, Javascript, jQuery, JSON, AJAX, React and
          Angular 2/4.
